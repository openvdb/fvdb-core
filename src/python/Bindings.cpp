...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    */
    ...
    auto version = m.def_submodule("version", "Build-time version information for fVDB dependencies.");
    ...
    version.attr("cuda") =
        py::str(std::to_string(CUDART_VERSION / 1000) + "." + std::to_string((CUDART_VERSION % 1000) / 10));
