...
//
#ifndef FVDB_DETAIL_UTILS_GAUSSIAN_GAUSSIANRASTERIZEOPTIONALINPUTS_H
#define FVDB_DETAIL_UTILS_GAUSSIAN_GAUSSIANRASTERIZEOPTIONALINPUTS_H
...
prepare_raster_optional_inputs(const torch::Tensor &features,
                               const int64_t C,
...
#endif // FVDB_DETAIL_UTILS_GAUSSIAN_GAUSSIANRASTERIZEOPTIONALINPUTS_H
