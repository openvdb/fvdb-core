...
SparseConvolutionImplicitGEMM::variable_list
SparseConvolutionImplicitGEMM::forward(AutogradContext *ctx,
                                       Variable inFeatures,
                                       Variable kernels,
...
SparseConvolutionImplicitGEMM::variable_list
SparseConvolutionImplicitGEMM::backward(AutogradContext *ctx, variable_list grad_output) {
