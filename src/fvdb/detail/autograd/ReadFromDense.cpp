...
ReadFromDense::variable_list
ReadFromDense::forward(ReadFromDense::AutogradContext *ctx,
                       c10::intrusive_ptr<GridBatchImpl> grid,
                       ReadFromDense::Variable denseData,
...
ReadFromDense::variable_list
ReadFromDense::backward(ReadFromDense::AutogradContext *ctx,
                        ReadFromDense::variable_list grad_output) {
