...
//
#ifndef FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDFORWARD_H
#define FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDFORWARD_H
...
#endif // FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDFORWARD_H
