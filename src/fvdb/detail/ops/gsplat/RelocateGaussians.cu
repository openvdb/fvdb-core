...
dispatchRelocateGaussians(const torch::Tensor &logScales,
...
__global__ void
relocateGaussiansKernel(int64_t localToGlobalOffset,
                        int64_t localSize,
...
launchGaussianRelocation(const torch::Tensor &logScales,      // [N, 3]
    ...
    relocateGaussiansKernel<ScalarType><<<gridDim, blockDim, 0, stream>>>(
        offset,
        size,
...
template <>
std::tuple<torch::Tensor, torch::Tensor>
dispatchRelocateGaussians<torch::kCUDA>(const torch::Tensor &logScales,      // [N, 3]
                                        const torch::Tensor &logitOpacities, // [N]
                                        const torch::Tensor &ratios,         // [N]
                                        const torch::Tensor &binomialCoeffs, // [nMax, nMax]
                                        const int nMax,
...
template <>
std::tuple<torch::Tensor, torch::Tensor>
dispatchRelocateGaussians<torch::kPrivateUse1>(const torch::Tensor &logScales,      // [N, 3]
                                               const torch::Tensor &logitOpacities, // [N]
                                               const torch::Tensor &ratios,         // [N]
                                               const torch::Tensor &binomialCoeffs, // [nMax, nMax]
                                               const int nMax,
...
template <>
std::tuple<torch::Tensor, torch::Tensor>
dispatchRelocateGaussians<torch::kCPU>(const torch::Tensor &logScales,      // [N, 3]
                                       const torch::Tensor &logitOpacities, // [N]
                                       const torch::Tensor &ratios,         // [N]
                                       const torch::Tensor &binomialCoeffs, // [nMax, nMax]
                                       const int nMax,
...
relocateGaussians(const torch::Tensor &logScales,      // [N, 3]
    ...
    return FVDB_DISPATCH_KERNEL(logScales.device(), [&]() {
        return dispatchRelocateGaussians<DeviceTag>(
