...
dispatchRasterizeScreenSpaceGaussiansFwd(const torch::Tensor &means2d,
...
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatchRasterizeScreenSpaceGaussiansSparseFwd(const fvdb::JaggedTensor &pixelsToRender,
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatchRasterizeScreenSpaceGaussiansFwd<torch::kCUDA>(
    // Gaussian parameters
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatchRasterizeScreenSpaceGaussiansFwd<torch::kPrivateUse1>(
    // Gaussian parameters
    const torch::Tensor &means2d,   // [C, N, 2]
    const torch::Tensor &conics,    // [C, N, 3]
    const torch::Tensor &features,  // [C, N, D]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatchRasterizeScreenSpaceGaussiansFwd<torch::kCPU>(
    // Gaussian parameters
    const torch::Tensor &means2d,   // [C, N, 2]
    const torch::Tensor &conics,    // [C, N, 3]
    const torch::Tensor &features,  // [C, N, D]
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatchRasterizeScreenSpaceGaussiansSparseFwd<torch::kCUDA>(
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatchRasterizeScreenSpaceGaussiansSparseFwd<torch::kPrivateUse1>(
    // sparse pixel coordinates
    const fvdb::JaggedTensor &pixelsToRender, // [C, maxPixelsPerCamera, 2]
    // Gaussian parameters
    const torch::Tensor &means2d,     // [C, N, 2]
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatchRasterizeScreenSpaceGaussiansSparseFwd<torch::kCPU>(
    // sparse pixel coordinates
    const fvdb::JaggedTensor &pixelsToRender, // [C, maxPixelsPerCamera, 2]
    // Gaussian parameters
    const torch::Tensor &means2d,     // [C, N, 2]
