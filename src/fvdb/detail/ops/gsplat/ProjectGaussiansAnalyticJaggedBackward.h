...
//
#ifndef FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDBACKWARD_H
#define FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDBACKWARD_H
...
/// parameters:
///         - 3D means [M, 3] - dL/dmeans
///         - Quaternions [M, 4] - dL/dquats
///         - Scales [M, 3] - dL/dscales
///         - View matrices [BC, 4, 4] - dL/dviewmats (if viewmats_requires_grad is true, otherwise
/// empty tensor)
///         - Camera intrinsics [BC, 3, 3] - dL/dKs
...
#endif // FVDB_DETAIL_OPS_GSPLAT_PROJECTGAUSSIANSANALYTICJAGGEDBACKWARD_H
