...
/// @param[in] logScales log of scales of Gaussians [N, 3] representing extent in each dimension
...
///         - Compensation factors [C, N] (if calcCompensations is true, otherwise empty tensor)
template <torch::DeviceType>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatchGaussianProjectionForwardUT(const torch::Tensor &means,                   // [N, 3]
