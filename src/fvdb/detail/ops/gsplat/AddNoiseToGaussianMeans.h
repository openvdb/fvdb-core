...
#ifndef FVDB_DETAIL_OPS_GSPLAT_ADDNOISETOGAUSSIANMEANS_H
#define FVDB_DETAIL_OPS_GSPLAT_ADDNOISETOGAUSSIANMEANS_H
...
void addNoiseToGaussianMeans(torch::Tensor &means,                // [N, 3] input/output
...
#endif // FVDB_DETAIL_OPS_GSPLAT_ADDNOISETOGAUSSIANMEANS_H
