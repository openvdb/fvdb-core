...
dispatch_rasterize_screen_space_gaussians_fwd(const torch::Tensor &means2d,
...
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatch_rasterize_screen_space_gaussians_sparse_fwd(const fvdb::JaggedTensor &pixelsToRender,
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_fwd<torch::kCUDA>(
    // Gaussian parameters
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_fwd<torch::kPrivateUse1>(
    // Gaussian parameters
    const torch::Tensor &means2d,   // [C, N, 2]
    const torch::Tensor &conics,    // [C, N, 3]
    const torch::Tensor &features,  // [C, N, D]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_fwd<torch::kCPU>(
    // Gaussian parameters
    const torch::Tensor &means2d,   // [C, N, 2]
    const torch::Tensor &conics,    // [C, N, 3]
    const torch::Tensor &features,  // [C, N, D]
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatch_rasterize_screen_space_gaussians_sparse_fwd<torch::kCUDA>(
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatch_rasterize_screen_space_gaussians_sparse_fwd<torch::kPrivateUse1>(
    // sparse pixel coordinates
    const fvdb::JaggedTensor &pixelsToRender, // [C, maxPixelsPerCamera, 2]
    // Gaussian parameters
    const torch::Tensor &means2d,     // [C, N, 2]
...
template <>
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
dispatch_rasterize_screen_space_gaussians_sparse_fwd<torch::kCPU>(
    // sparse pixel coordinates
    const fvdb::JaggedTensor &pixelsToRender, // [C, maxPixelsPerCamera, 2]
    // Gaussian parameters
    const torch::Tensor &means2d,     // [C, N, 2]
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
rasterize_screen_space_gaussians_fwd(const torch::Tensor &means2d,
                                     const torch::Tensor &conics,
                                     const torch::Tensor &features,
                                     const torch::Tensor &opacities,
    ...
    return FVDB_DISPATCH_KERNEL(means2d.device(), [&]() {
        return dispatch_rasterize_screen_space_gaussians_fwd<DeviceTag>(means2d,
                                                                        conics,
                                                                        features,
                                                                        opacities,
                                                                        renderWindow,
...
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor, fvdb::JaggedTensor>
rasterize_screen_space_gaussians_sparse_fwd(const fvdb::JaggedTensor &pixelsToRender,
                                            const torch::Tensor &means2d,
                                            const torch::Tensor &conics,
                                            const torch::Tensor &features,
                                            const torch::Tensor &opacities,
    ...
    const RenderWindow2D renderWindow{imageWidth, imageHeight, imageOriginW, imageOriginH};
    return FVDB_DISPATCH_KERNEL(means2d.device(), [&]() {
        return dispatch_rasterize_screen_space_gaussians_sparse_fwd<DeviceTag>(pixelsToRender,
                                                                               means2d,
                                                                               conics,
                                                                               features,
                                                                               opacities,
