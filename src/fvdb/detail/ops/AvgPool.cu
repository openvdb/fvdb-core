...
avgPoolVoxelCallback(int32_t batchIdx,
                     int32_t leafIdx,
                     int32_t voxelIdx,
                     int32_t channelIdx,
...
torch::Tensor
DownsampleGridAvgPool(const GridBatchData &fineBatchHdl,
...
template <torch::DeviceType DeviceTag>
torch::Tensor
DownsampleGridAvgPoolBackward(const GridBatchData &coarseBatchHdl,
