...
dispatch_project_gaussians_analytic_bwd(
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_project_gaussians_analytic_bwd<torch::kCUDA>(
    // fwd inputs
    const torch::Tensor &means,                       // [N, 3]
    const torch::Tensor &quats,                       // [N, 4]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_project_gaussians_analytic_bwd<torch::kPrivateUse1>(
    // fwd inputs
    const torch::Tensor &means,                       // [N, 3]
    const torch::Tensor &quats,                       // [N, 4]
    const torch::Tensor &logScales,                   // [N, 3]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_project_gaussians_analytic_bwd<torch::kCPU>(
    // fwd inputs
    const torch::Tensor &means,                       // [N, 3]
    const torch::Tensor &quats,                       // [N, 4]
    const torch::Tensor &logScales,                   // [N, 3]
...
project_gaussians_analytic_bwd(
    ...
    return FVDB_DISPATCH_KERNEL(means.device(), [&]() {
        return dispatch_project_gaussians_analytic_bwd<DeviceTag>(
            means,
            quats,
            scales,
            worldToCamMatrices,
