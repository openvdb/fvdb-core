...
__hostdev__ void
segmentsAlongRaysCallback(int32_t bidx,
                          int32_t rayIdx,
...
template <typename ScalarType,
          ...
          typename TensorAccessor>
__hostdev__ void
countSegmentsAlongRaysCallback(int32_t bidx,
                               int32_t eidx,
        ...
        AT_WRAP([&]() -> JaggedTensor {
            ...
            if constexpr (DeviceTag == torch::kCUDA) {
                ...
                auto cb1 = [=](int32_t bidx,
                    ...
                    countSegmentsAlongRaysCallback<scalar_t, JaggedAcc, TorchAcc>(bidx,
                                                                                  eidx,
                                                                                  rOA,
                                                                                  rayDirectionsAcc,
                                                                                  outCountsAcc,
            ...
            if constexpr (DeviceTag == torch::kCUDA) {
                ...
                auto cb2 = [=](int32_t bidx,
                    ...
                    segmentsAlongRaysCallback<scalar_t, JaggedAcc, TorchAcc>(bidx,
                                                                             eidx,
                                                                             rayOriginsAcc,
                                                                             rayDirectionsAcc,
                                                                             outJOffsetsAcc,
