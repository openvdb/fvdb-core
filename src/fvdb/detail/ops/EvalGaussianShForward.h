...
//
#ifndef FVDB_DETAIL_OPS_EVALGAUSSIANSHFORWARD_H
#define FVDB_DETAIL_OPS_EVALGAUSSIANSHFORWARD_H
...
torch::Tensor eval_gaussian_sh_fwd(const int64_t shDegreeToUse,
...
torch::Tensor eval_spherical_harmonics(const torch::Tensor &means,
...
#endif // FVDB_DETAIL_OPS_EVALGAUSSIANSHFORWARD_H
