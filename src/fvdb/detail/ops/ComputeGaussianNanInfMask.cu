...
fvdb::JaggedTensor dispatch_compute_gaussian_nan_inf_mask(const fvdb::JaggedTensor &means,
...
template <>
fvdb::JaggedTensor
dispatch_compute_gaussian_nan_inf_mask<torch::kCUDA>(const fvdb::JaggedTensor &means,
                                                     const fvdb::JaggedTensor &quats,
                                                     const fvdb::JaggedTensor &logScales,
                                                     const fvdb::JaggedTensor &logitOpacities,
                                                     const fvdb::JaggedTensor &sh0,
...
template <>
fvdb::JaggedTensor
dispatch_compute_gaussian_nan_inf_mask<torch::kPrivateUse1>(
    const fvdb::JaggedTensor &means,
    const fvdb::JaggedTensor &quats,
    const fvdb::JaggedTensor &logScales,
    const fvdb::JaggedTensor &logitOpacities,
    const fvdb::JaggedTensor &sh0,
...
template <>
fvdb::JaggedTensor
dispatch_compute_gaussian_nan_inf_mask<torch::kCPU>(const fvdb::JaggedTensor &means,
                                                    const fvdb::JaggedTensor &quats,
                                                    const fvdb::JaggedTensor &logScales,
                                                    const fvdb::JaggedTensor &logitOpacities,
                                                    const fvdb::JaggedTensor &sh0,
    ...
    TORCH_CHECK_NOT_IMPLEMENTED(
        false, "dispatch_compute_gaussian_nan_inf_mask not implemented on the CPU");
}

fvdb::JaggedTensor
compute_gaussian_nan_inf_mask(const fvdb::JaggedTensor &means,
                              const fvdb::JaggedTensor &quats,
                              const fvdb::JaggedTensor &logScales,
                              const fvdb::JaggedTensor &logitOpacities,
                              const fvdb::JaggedTensor &sh0,
    ...
    return FVDB_DISPATCH_KERNEL(means.device(), [&]() {
        return dispatch_compute_gaussian_nan_inf_mask<DeviceTag>(
