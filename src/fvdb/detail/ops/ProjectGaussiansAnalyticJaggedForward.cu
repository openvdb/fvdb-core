...
dispatch_project_gaussians_analytic_jagged_fwd(const torch::Tensor &gSizes, // [B] gaussian sizes
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_project_gaussians_analytic_jagged_fwd<torch::kCUDA>(
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_project_gaussians_analytic_jagged_fwd<torch::kCPU>(
    const torch::Tensor &gSizes,             // [B] gaussian sizes
    const torch::Tensor &means,              // [N, 3]
    const torch::Tensor &quats,              // [N, 4] optional
    const torch::Tensor &scales,             // [N, 3] optional
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
project_gaussians_analytic_jagged_fwd(const torch::Tensor &gSizes,             // [B] gaussian sizes
                                      const torch::Tensor &means,              // [N, 3]
                                      const torch::Tensor &quats,              // [N, 4] optional
                                      const torch::Tensor &scales,             // [N, 3] optional
                                      const torch::Tensor &cSizes,             // [B] camera sizes
    ...
    return FVDB_DISPATCH_KERNEL_DEVICE(means.device(), [&]() {
        return dispatch_project_gaussians_analytic_jagged_fwd<DeviceTag>(gSizes,
                                                                         means,
                                                                         quats,
                                                                         scales,
                                                                         cSizes,
