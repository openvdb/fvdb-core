...
//
#ifndef FVDB_DETAIL_OPS_IDENTIFYCONTRIBUTINGGAUSSIANS_H
#define FVDB_DETAIL_OPS_IDENTIFYCONTRIBUTINGGAUSSIANS_H
...
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor> identify_contributing_gaussians(
...
///
/// @return (gaussian_ids, weights) as JaggedTensors
std::tuple<fvdb::JaggedTensor, fvdb::JaggedTensor> identify_contributing_gaussians_sparse(
    const torch::Tensor &means2d,
    const torch::Tensor &conics,
    const torch::Tensor &opacities,
    const torch::Tensor &tile_offsets,
...
#endif // FVDB_DETAIL_OPS_IDENTIFYCONTRIBUTINGGAUSSIANS_H
