...
#include <fvdb/detail/utils/cuda/Prefetch.cuh>
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_bwd(const torch::Tensor &means2d,
...
template <torch::DeviceType>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_sparse_bwd(
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_bwd<torch::kCUDA>(
    ...
    const torch::Tensor &tileOffsets,            // [C, numTilesH, numTilesW]
    const torch::Tensor &tileGaussianIds,        // [totalIntersections]
    const torch::Tensor &renderedAlphas,         // [C, renderHeight, renderWidth, 1]
    const torch::Tensor &lastGaussianIds,        // [C, renderHeight, renderWidth]
    const torch::Tensor &dLossDRenderedFeatures, // [C, renderHeight, renderWidth, 3]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_bwd<torch::kPrivateUse1>(
    const torch::Tensor &means2d,                // [C, N, 2]
    const torch::Tensor &conics,                 // [C, N, 3]
    const torch::Tensor &features,               // [C, N, 3]
    const torch::Tensor &opacities,              // [N]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_bwd<torch::kCPU>(
    const torch::Tensor &means2d,                // [C, N, 2]
    const torch::Tensor &conics,                 // [C, N, 3]
    const torch::Tensor &features,               // [C, N, 3]
    const torch::Tensor &opacities,              // [N]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_sparse_bwd<torch::kCUDA>(
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_sparse_bwd<torch::kPrivateUse1>(
    const fvdb::JaggedTensor &pixelsToRender, // [C, NumPixels, 2]
    const torch::Tensor &means2d,             // [C, N, 2]
    const torch::Tensor &conics,              // [C, N, 3]
    const torch::Tensor &features,            // [C, N, D]
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatch_rasterize_screen_space_gaussians_sparse_bwd<torch::kCPU>(
    const fvdb::JaggedTensor &pixelsToRender, // [C, NumPixels, 2]
    const torch::Tensor &means2d,             // [C, N, 2]
    const torch::Tensor &conics,              // [C, N, 3]
    const torch::Tensor &features,            // [C, N, D]
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
rasterize_screen_space_gaussians_bwd(const torch::Tensor &means2d,
                                     const torch::Tensor &conics,
                                     const torch::Tensor &features,
                                     const torch::Tensor &opacities,
    ...
    return FVDB_DISPATCH_KERNEL(means2d.device(), [&]() {
        return dispatch_rasterize_screen_space_gaussians_bwd<DeviceTag>(means2d,
                                                                        conics,
                                                                        features,
                                                                        opacities,
                                                                        renderWindow,
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
rasterize_screen_space_gaussians_sparse_bwd(const fvdb::JaggedTensor &pixelsToRender,
                                            const torch::Tensor &means2d,
                                            const torch::Tensor &conics,
                                            const torch::Tensor &features,
                                            const torch::Tensor &opacities,
    ...
    const RenderWindow2D renderWindow{imageWidth, imageHeight, imageOriginW, imageOriginH};
    return FVDB_DISPATCH_KERNEL(means2d.device(), [&]() {
        return dispatch_rasterize_screen_space_gaussians_sparse_bwd<DeviceTag>(
            pixelsToRender,
            means2d,
            conics,
            features,
