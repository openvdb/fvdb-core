...
// eliminating zero-padding waste present in the dense kernel-map path.
//
...
//
// This is equivalent to GatherScatterDefaultTopology but uses a separate type
// to keep the API boundary clean.  Built once and reused across multiple
// convolutions on the same grid pair.
...
///
/// Internally builds a GatherScatterDefaultTopology and converts it into
/// the GroupedGemmTopology format.
