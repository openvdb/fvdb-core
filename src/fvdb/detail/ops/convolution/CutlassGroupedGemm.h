...
/// @param features     Input features from the forward pass, shape [feature_total_voxels, Cin],
/// fp16.
/// @param weights      Kernel weights, shape [Cout, Cin, k0, k1, k2], fp16.
...
std::tuple<torch::Tensor, torch::Tensor> cutlassConvBackward(torch::Tensor grad_output,
...
torch::Tensor cutlassConvTranspose(torch::Tensor features,
                                   torch::Tensor weights,
                                   CutlassConvTopology const &topo);
