...
conv_forward_cuda_setting1_mode1_bf16bf16f32(int M,
    ...
    [[maybe_unused]] __nv_bfloat16 A_shared_warp[32];
...
conv_forward_cuda_setting1_mode1_f16f16f32(int M,
    ...
    [[maybe_unused]] half A_shared_warp[32];
...
conv_forward_cuda_setting2_mode1_bf16bf16f32(int M,
    ...
    [[maybe_unused]] [[maybe_unused]] __nv_bfloat16 A_shared_warp[32];
    [[maybe_unused]] [[maybe_unused]] __nv_bfloat16 B_shared_warp[8];
    for (int i0_0_3_init = 0; i0_0_3_init < 4; ++i0_0_3_init) {
        for (int i = 0; i < 8; ++i) {
            C_warp[(i0_0_3_init * 8) + i] = 0.0;
        }
...
conv_forward_cuda_setting3_mode1_bf16bf16f32(int M,
    ...
    [[maybe_unused]] [[maybe_unused]] __nv_bfloat16 A_shared_warp[32];
    [[maybe_unused]] [[maybe_unused]] __nv_bfloat16 B_shared_warp[16];
    for (int i0_0_3_init = 0; i0_0_3_init < 4; ++i0_0_3_init) {
...
conv_forward_cuda_setting1_mode1_tf32tf32f32(int M,
    ...
    [[maybe_unused]] float A_shared_warp[32];
...
template <>
torch::Tensor
dispatchSparseConvolutionImplicitGEMMSorted<torch::kCUDA>(torch::Tensor _in_feats,
            ...
            if (num_in_channels % 16 == 0) {
                if (num_out_channels % 16 == 0) {
                    conv_forward_cuda_setting1_mode1_bf16bf16f32<16, 16, false, false>
                        <<<num_blocks, threads_per_block>>>(num_out_feats,
                                                            num_in_channels,
                                                            num_out_channels,
                                                            kernel_volume,
                                                            split_mask_len,
...
template <>
torch::Tensor
dispatchSparseConvolutionImplicitGEMMSorted<torch::kCPU>(torch::Tensor _in_feats,
                                                         torch::Tensor _kernel,
                                                         torch::Tensor _out_in_map,
                                                         torch::Tensor _reduced_mask,
                                                         torch::Tensor _reorder_loc,
