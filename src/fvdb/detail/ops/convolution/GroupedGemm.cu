...
// =============================================================================
// Topology conversion: GatherScatterDefaultTopology -> GroupedGemmTopology
// =============================================================================

static GroupedGemmTopology
fromDefaultTopology(GatherScatterDefaultTopology const &src) {
    return GroupedGemmTopology{
        src.gatherIndices,
        src.scatterIndices,
        src.offsets,
        src.featureTotalVoxels,
        src.outputTotalVoxels,
        src.kernelVolume,
        src.totalPairs,
        src.kernelSize,
        src.stride,
...
groupedGemmSparseConvTopology(GridBatchImpl const &feature_grid,
    ...
    return fromDefaultTopology(
        gatherScatterDefaultSparseConvTopology(feature_grid, output_grid, kernel_size, stride));
}
...
groupedGemmSparseConvTransposeTopology(GridBatchImpl const &feature_grid,
                                       ...
                                       nanovdb::Coord kernel_size,
                                       nanovdb::Coord stride) {
    return fromDefaultTopology(gatherScatterDefaultSparseConvTransposeTopology(
