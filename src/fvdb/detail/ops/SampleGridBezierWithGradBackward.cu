...
__hostdev__ void
sampleBezierWithGradBackwardCallback(int32_t bidx,
                                     int32_t eidx,
                                     int32_t cidx,
...
SampleGridBezierWithGradBackward(const GridBatchImpl &batchHdl,
    ...
    AT_DISPATCH_V2(
        points.scalar_type(),
        "SampleGridBezierWithGradBackward",
        AT_WRAP([&] {
            ...
            if constexpr (DeviceTag == torch::kCUDA) {
                ...
                auto cb = [=](int32_t bidx,
                    ...
                    sampleBezierWithGradBackwardCallback<DeviceTag, scalar_t, JaggedAcc, TorchAcc>(
                        bidx,
                        eidx,
                        cidx,
                        pts,
