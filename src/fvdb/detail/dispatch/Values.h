...
template <typename SubsetT, typename SupersetT> struct is_subset_of : std::false_type {};

template <typename SubsetT, typename SupersetT>
inline constexpr bool is_subset_of_v = is_subset_of<SubsetT, SupersetT>::value;
