...
TEST_F(GaussianTileIntersectionTest, CPUNotImplementedTest) {
    ...
    EXPECT_THROW(fvdb::detail::ops::gaussianTileIntersection(means2d.cpu(),
                                                             radii.cpu(),
                                                             depths.cpu(),
...
TEST_F(GaussianTileIntersectionTest, ZeroLengthGaussianTest) {
    ...
    auto [tile_offsets, intersection_values] =
        fvdb::detail::ops::gaussianTileIntersection(means2d.cuda(),
                                                    radii.cuda(),
                                                    depths.cuda(),
                                                    /*camera_jidx=*/at::nullopt,
                                                    numCameras,
...
TEST_F(GaussianTileIntersectionTest, BadInputsFailTest) {
    ...
    for (auto config: configs) {
        ...
        if (isPacked) {
            ...
            EXPECT_THROW(fvdb::detail::ops::gaussianTileIntersection(means2d.cuda(),
                                                                     radii.cuda(),
                                                                     depths.cuda(),
                                                                     cameraJidx.cuda(),
                                                                     nc,
...
TEST_F(GaussianTileIntersectionTest, PackedFormatTest) {
    ...
    auto [tile_offsets, intersection_values] =
        fvdb::detail::ops::gaussianTileIntersection(means2d_packed.cuda(),
                                                    radii_packed.cuda(),
                                                    depths_packed.cuda(),
                                                    camera_indices.cuda(),
                                                    num_cameras,
...
TEST_F(GaussianTileIntersectionTest, DenseViaSparseTest) {
    ...
    auto [tile_offsets, intersection_values] =
        fvdb::detail::ops::gaussianSparseTileIntersection(means2d.cuda(),
                                                          radii.cuda(),
                                                          depths.cuda(),
                                                          tile_mask.cuda(),
                                                          active_tiles.cuda(),
...
TEST_F(GaussianTileIntersectionTest, SparseCPUNotImplementedTest) {
    ...
    EXPECT_THROW(fvdb::detail::ops::gaussianSparseTileIntersection(means2d.cpu(),
                                                                   radii.cpu(),
                                                                   depths.cpu(),
                                                                   tile_mask.cpu(),
                                                                   active_tiles.cpu(),
...
TEST_F(GaussianTileIntersectionTest, SparsePackedFormatTest) {
    ...
    auto [tile_offsets, intersection_values] =
        fvdb::detail::ops::gaussianSparseTileIntersection(means2d_packed.cuda(),
                                                          radii_packed.cuda(),
                                                          depths_packed.cuda(),
                                                          tile_mask.cuda(),
                                                          active_tiles.cuda(),
