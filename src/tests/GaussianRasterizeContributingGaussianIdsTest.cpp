...
TEST_F(GaussianRasterizeContributingGaussianIdsTestFixture, TestBasicInputsAndOutputs) {
    ...
    const auto [numContributingGaussians, alphas] =
        fvdb::detail::ops::countContributingGaussians(means2d,
                                                      conics,
                                                      opacities,
                                                      tileOffsets,
                                                      tileGaussianIds,
    ...
    const auto [outIds, outWeights] =
        fvdb::detail::ops::identifyContributingGaussians(means2d,
                                                         conics,
                                                         opacities,
                                                         tileOffsets,
                                                         tileGaussianIds,
...
TEST_F(GaussianRasterizeContributingGaussianIdsTestFixture, TestBasicInputsAndOutputsSparse) {
    ...
    const auto [numContributingGaussiansSparse, alphasSparse] =
        fvdb::detail::ops::countContributingGaussiansSparse(means2d,
                                                            conics,
                                                            opacities,
                                                            tileOffsets,
                                                            tileGaussianIds,
    ...
    const auto [outIdsSparse, outWeightsSparse] =
        fvdb::detail::ops::identifyContributingGaussiansSparse(means2d,
                                                               conics,
                                                               opacities,
                                                               tileOffsets,
                                                               tileGaussianIds,
...
TEST_F(GaussianRasterizeContributingGaussianIdsTestFixture, CPUThrows) {
    ...
    EXPECT_THROW(fvdb::detail::ops::countContributingGaussians(means2d,
                                                               conics,
                                                               opacities,
                                                               tileOffsets,
                                                               tileGaussianIds,
