...
class GaussianTestHelper {
  public:
    ...
    createSparseSetup(int tileSize,
        ...
        auto [activeTiles, activeTileMask, tilePixelMask, tilePixelCumsum, pixelMap] =
            fvdb::detail::ops::build_sparse_gaussian_tile_layout(
                tileSize, numTilesW, numTilesH, pixelsToRender);
    ...
    runForwardDense(const GaussianParams &gaussians,
                    ...
                    int imageHeight,
                    int tileSize) {
        auto [colors, alphas, lastIds] = fvdb::detail::ops::rasterize_screen_space_gaussians_fwd(
            gaussians.means2d,
            gaussians.conics,
            gaussians.colors,
            gaussians.opacities,
    ...
    runBackwardDense(const GaussianParams &gaussians,
        ...
        auto [dLossDMeans2dAbs, dLossDMeans2d, dLossDConics, dLossDColors, dLossDOpacities] =
            fvdb::detail::ops::rasterize_screen_space_gaussians_bwd(
                gaussians.means2d,
                gaussians.conics,
                gaussians.colors,
                gaussians.opacities,
    ...
    runBackwardSparse(const GaussianParams &gaussians,
                      ...
                      int64_t numSharedChannelsOverride = -1) {
        auto [dLossDMeans2dAbs, dLossDMeans2d, dLossDConics, dLossDColors, dLossDOpacities] =
            fvdb::detail::ops::rasterize_screen_space_gaussians_sparse_bwd(
                sparse.pixelsToRender,
                gaussians.means2d,
                gaussians.conics,
                gaussians.colors,
...
TEST_F(GaussianRasterizeTestFixture, CPUThrows) {
    ...
    EXPECT_THROW(
        fvdb::detail::ops::rasterize_screen_space_gaussians_bwd(means2d,
                                                                conics,
                                                                colors,
                                                                opacities,
                                                                static_cast<uint32_t>(imageWidth),
...
TEST_F(GaussianRasterizeTestFixture, TestDenseBackwardWithBackgrounds) {
    ...
    auto [colorsWithBg, alphasWithBg, lastIdsWithBg] =
        fvdb::detail::ops::rasterize_screen_space_gaussians_fwd(gaussians.means2d,
                                                                gaussians.conics,
                                                                gaussians.colors,
                                                                gaussians.opacities,
                                                                static_cast<uint32_t>(imageWidth),
    ...
    auto [dLossDMeans2dAbsWithBg,
        ...
        fvdb::detail::ops::rasterize_screen_space_gaussians_bwd(gaussians.means2d,
                                                                gaussians.conics,
                                                                gaussians.colors,
                                                                gaussians.opacities,
                                                                static_cast<uint32_t>(imageWidth),
...
TEST_F(GaussianRasterizeTestFixture, TestPackedModeBackwardMultipleCameras) {
    ...
    const auto [expectedDMeans2dAbs,
        ...
        fvdb::detail::ops::rasterize_screen_space_gaussians_bwd(
            ...
            gaussians.colors,
            gaussians.opacities,
            static_cast<uint32_t>(testImageWidth),
