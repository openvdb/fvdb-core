...
TEST_F(GaussianRasterizeTopContributorsTestFixture, TestBasicInputsAndOutputs) {
    ...
    const auto [outIds, outWeights] =
        fvdb::detail::ops::identify_top_contributing_gaussians(means2d,
                                                               conics,
                                                               opacities,
                                                               tileOffsets,
                                                               tileGaussianIds,
...
TEST_F(GaussianRasterizeTopContributorsTestFixture, TestBasicInputsAndOutputsSparse) {
    ...
    const auto [outIdsSparse, outWeightsSparse] =
        fvdb::detail::ops::identify_top_contributing_gaussians_sparse(means2d,
                                                                      conics,
                                                                      opacities,
                                                                      tileOffsets,
                                                                      tileGaussianIds,
...
TEST_F(GaussianRasterizeTopContributorsTestFixture, CPUThrows) {
    ...
    EXPECT_THROW(fvdb::detail::ops::identify_top_contributing_gaussians(means2d,
                                                                        conics,
                                                                        opacities,
                                                                        tileOffsets,
                                                                        tileGaussianIds,
