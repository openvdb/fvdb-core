...
class GaussianRelocationTest : public ::testing::Test {
  protected:
    ...
    TestRelocation(const torch::Tensor &logScales,
        ...
        const auto [gpuLogitOpacitiesNew, gpuLogScalesNew] = fvdb::detail::ops::relocateGaussians(
...
TEST_F(GaussianRelocationTest, ValidatesInputs) {
    ...
    EXPECT_THROW(fvdb::detail::ops::relocateGaussians(
    ...
    // opacities on CPU
    EXPECT_THROW(
        fvdb::detail::ops::relocateGaussians(
