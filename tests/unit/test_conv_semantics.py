...
@pytest.mark.parametrize("kernel", range(1, 7))
@pytest.mark.parametrize("stride", range(1, 6))
def test_scalar_relation_matrix_covers_signed_residues(kernel: int, stride: int) -> None:
...
@pytest.mark.parametrize("kernel", range(1, 7))
def test_componentwise_kernel_equals_stride_projection(kernel: int) -> None:
...
def test_signed_division_and_even_torch_phase() -> None:
...
def test_issue_668_one_dimensional_endpoint_counts() -> None:
...
def test_issue_668_16_cubed_round_trip_structural_regression() -> None:
...
def test_scalar_edges_support_and_round_trip_for_mixed_signed_geometry(kernel, stride) -> None:
    relation = ConvolutionRelation(kernel, stride)
...
def test_dense_forward_counts_and_sparse_scalar_degrees_agree() -> None:
...
def test_dense_forward_values_and_gradients_match_scalar_relation() -> None:
...
def test_dense_transpose_support_and_asymmetric_channel_adapter() -> None:
...
def test_dense_oracles_satisfy_asymmetric_channel_adjoint_identity() -> None:
...
def test_explicit_restriction_and_zero_feature_structure() -> None:
...
def test_dense_oracle_preflight_fails_before_allocation() -> None:
