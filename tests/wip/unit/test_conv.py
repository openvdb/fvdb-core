...
class TestConv(unittest.TestCase):
    ...
    def test_conv_vs_torch_dense_simple(self, device, dtype, backend):
        ...
        out_dense_features = target_grid.write_to_dense_cminor(out_vdb_features).squeeze(0).permute(3, 2, 1, 0)
    ...
    def test_torch_transposed_sparse_conv(self, device, dtype, backend, kernel_size, stride):
        ...
        dense_features = target_grid.write_to_dense_cminor(JaggedTensor(vdb_features)).squeeze(0).permute(3, 2, 1, 0)
