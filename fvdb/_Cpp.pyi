...
class GridBatch:
    ...
    def inject_from(self, src_grid: GridBatch, src: JaggedTensor, dst: JaggedTensor) -> None: ...
    ...
    def marching_cubes(self, field, level=0.0): ...
    ...
    def sample_bezier(self, points, voxel_data) -> JaggedTensor: ...
    def sample_bezier_with_grad(self, points, voxel_data) -> Tuple[JaggedTensor, JaggedTensor]: ...
    def sample_trilinear(self, points, voxel_data) -> JaggedTensor: ...
    def sample_trilinear_with_grad(self, points, voxel_data) -> Tuple[JaggedTensor, JaggedTensor]: ...
